 ...
 * @author drumm
 */
public class ConnectionBdD extends GridPane {

    private PageConnection main;
    ...
    public ConnectionBdD(PageConnection main) {
        this.main = main;
...
//                Connection con = Utilisateur.connectGeneralPostGres(this.tfHost.getText(),
//                        port,
